...
<body>
            ...
            <div class="container-fluid navbar-item">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasNavbarLabel">PT. Anugerah Tambang</h5>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('tentangkami') ? 'active' : '' }}"
    ...
    <footer class="d-flex flex-wrap align-items-center py-3">
        ...
        <div class="col-md-4 d-flex align-items-center justify-content-center">
            <img data-src="{{ asset('assets/images/logo.png') }}" width=30, height=30, class="d-inline-block align-text-top lazyload"
                alt="logo">
